...
class RoadMapPlotTool(BuiltinTool):
    def _invoke(
        ...
        try:
            ...
            # 检查 tech_class_name 列是否存在
            tech_class_index = column_names.index('tech_class_name') if 'tech_class_name' in column_names else None
            ...
            for row in rows:
                ...
                tech_class = row[tech_class_index] if tech_class_index is not None else None  # 获取道路技术等级
